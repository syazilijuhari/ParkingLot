...
public class VStaffPark extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == btn1) {
			try {
				File fileIn = new File("Parking/B1lot.txt");
			...
			try {
				File fileIn = new File("Parking/B2lot.txt");
			...
			try {
				File fileIn = new File("Parking/B3lot.txt");
			...
			try {
				File fileIn = new File("Parking/B4lot.txt");
